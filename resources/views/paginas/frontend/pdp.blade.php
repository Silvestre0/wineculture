...
@section('content')
    <div class="ui container" id="rowpdp">
        <div class="ui styled fluid accordion pdp">
            ...
            <div class="content active pdp">
                <p>A sua privacidade é importante para nós. É política do WineCulture respeitar a sua privacidade em relação
                    a qualquer informação sua que possamos coletar no site <a
                        href=https://www.wineculture.pt />WineCulture</a>, e outros sites que possuímos e operamos.
        ...
        <div class="ui styled fluid accordion">
            <div class="title pdp active">
                <i class="dropdown icon"></i>
                Política de Cookies WineCulture
            </div>
            <div class="content active">
                <div class="accordion">
                    <div class="title segundo pdp">
                        <i class="dropdown icon"></i>
                        O que são cookies?
                    </div>
                    ...
                    <div class="content pdp">
                        <p>
                            ...
                            (consulte a Ajuda do
                            navegador para saber como fazer isso). Esteja ciente de que a desativação de cookies afetará
                            a
                            funcionalidade
                    ...
                    <div class="content pdp">
                        ...
                        <ul>
                            ...
                            <li class="mb-4">
                                ...
                                inscrição e
                                administração geral. Esses cookies geralmente serão excluídos quando você sair do
                                sistema,
                                porém, em alguns
                                casos, eles poderão permanecer
                                posteriormente para lembrar as preferências do seu site ao sair.
                            </li>
                            <h3 class="header_li">Cookies relacionados ao login</h3>
                            <li class="mb-4">
                            ...
                            <h3 class="header_li">Cookies relacionados a boletins por e-mail</h3>
                            <li class="mb-4">
                            ...
                            <h3 class="header_li">Pedidos processando cookies relacionados</h3>
                            <li class="mb-4">
                            ...
                            <h3 class="header_li">Cookies relacionados a pesquisas</h3>
                            <li class="mb-4">
                                Periodicamente, oferecemos pesquisas e questionários para fornecer informações
                                interessantes, ferramentas
                                úteis ou para entender nossa base de usuários com mais precisão. Essas pesquisas podem
                                usar
                                cookies para
                                lembrar quem já participou
                                numa pesquisa ou para fornecer resultados precisos após a alteração das páginas.
                            </li>
                            <h3 class="header_li">Cookies relacionados a formulários</h3>
                            <li class="mb-4">
                                Quando você envia dados por meio de um formulário como os encontrados nas páginas de
                                contacto ou nos
                                formulários de comentários, os cookies podem ser configurados para lembrar os detalhes
                                do
                                usuário para
                                correspondência futura.
                            </li>
                            <h3 class="header_li">Cookies de preferências do site</h3>
                            <li>
                    ...
                    <div class="content pdp">
                        ...
                        <ul>
                            <li class="mb-4">
                                ...
                                possamos continuar
                                produzindo conteúdo atrativo. Esses cookies podem rastrear itens como o tempo que você
                                passa
                                no site ou as
                        ...
                        <h3 class="header_li">Mais informações</h3>
                        <p>
                            Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você
                            não
                            tem certeza se
                            precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um
                            dos
                            recursos que você
                            usa em nosso site.
                    </div>
